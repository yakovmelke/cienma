...
const SubComponent = ({ member }) => {
  ...
  return (
    <div className="w-full sm:w-[45%] md:w-[30%] lg:w-[23%] p-3 border border-stone-300 rounded-sm bg-slate-200 text-black bg-opacity-60  shadow-lg shadow-white mb-6 text-center hover:bg-red-500 hover:text-white duration-500">
      ...
      ):<h1 className="text-center text-4xl font-bold text-red-800">You are not authorized</h1>}
    </div>
  );
};
