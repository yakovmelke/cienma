  ...
  return (
    <div className="mb-16">
      <div className="shadow-md w-full fixed top-0 left-0 ">
        <div className="md:flex opacity-80  bg-black items-center justify-between py-4 md:px-10 px-7">
          ...
          <ul
            className={`md:flex 
            bg-black  md:items-center md:pb-0 pb-12 absolute md:static  md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
              open
                ? "top-16 opacity-90"
